...
async function fetchSystemContext() {
  const courses = await CourseModel.find({ status: 'Published' })
    .select('title shortDescription level category')
    .lean();
  ...
  return { courses: courseList, batches: batchList };
}
  ...
  const courseContext =
    context.courses.length > 0
      ? context.courses
          .map(
            (c, i) =>
              `${i + 1}. **${c.title}**\n   - বিভাগ: ${c.category}\n   - স্তর: ${c.level}\n   - বিবরণ: ${c.shortDescription}`
          )
          .join('\n\n')
      : 'বর্তমানে কোনো কোর্স পাওয়া যাচ্ছে না।';
...
4. **প্রশ্ন:** আমি কিভাবে Misun Academy-এ এনরোল করব?
   **উত্তর:** আমাদের ওয়েবসাইটে গিয়ে পছন্দের কোর্স ও ব্যাচ নির্বাচন করে SSLCommerz-এর মাধ্যমে পেমেন্ট সম্পন্ন করে এনরোল করতে পারেন।
...
${env.MA_WHATSAPP_GROUP_LINK ? `- **হোয়াটসঅ্যাপ গ্রুপ:** ${env.MA_WHATSAPP_GROUP_LINK}` : ''}
...
## নির্দেশনা
1. **সর্বদা বাংলায় উত্তর দাও** (ব্যতিক্রম: ব্যবহারকারী ইংরেজিতে প্রশ্ন করলে ইংরেজিতেও উত্তর দিতে পারো)
2. উত্তর সংক্ষিপ্ত, নির্ভুল এবং বন্ধুত্বপূর্ণ হওয়া উচিত
3. মূল্য সংক্রান্ত প্রশ্নে বর্তমান ব্যাচের মূল্য উল্লেখ করো
4. পেমেন্ট সংক্রান্ত প্রশ্নে SSLCommerz ও ম্যানুয়াল পেমেন্ট অপশন দুটোরই তথ্য দাও
5. রিফান্ড সম্পর্কে জানতে চাইলে ২৪ ঘন্টার নীতির কথা উল্লেখ করো
6. যদি কোনো তথ্য না জানো, তাহলে সৎভাবে বলো "এই বিষয়ে আমার কাছে তথ্য নেই" এবং সাপোর্ট নাম্বার 01778371211 বা 01970713708 অথবা হোয়াটসঅ্যাপে যোগাযোগ করতে বলো
7. টিম মেম্বার বা স্টাফ সম্পর্কে জানতে চাইলে উপরোক্ত তালিকা থেকে তথ্য দাও
8. দীর্ঘ উত্তর না দিয়ে প্রয়োজনীয় তথ্যটি সংক্ষেপে দাও
9. ওয়েবসাইটের লিংক দিতে বললে www.misun-academy.com বলো
10. ব্যবহারকারীকে সর্বদা সহায়ক ও বন্ধুত্বপূর্ণ আচরণ করো
11. সাপোর্ট বা সাহায্য চাইলে সাপোর্ট নাম্বার দিন: 01778371211, 01970713708 এবং হোয়াটসঅ্যাপ: +8801331024530, +8801871952212 (২৪/৭ অলটাইম সাপোর্ট)
